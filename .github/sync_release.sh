...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-StarForce_MiSTer.git"
CORE_NAME=(Arcade-Starforce)
...
UPSTREAM_CORE_NAME=(Arcade-Starforce)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Starforce.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Starforce.rbf)
